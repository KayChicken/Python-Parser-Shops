...
def get_data_globus(search,list_items): 
    ...
    for item in items:
        ...
        item_basePrice = link_parser.find("span", class_="catalog-detail__item-price-actual-main").text
        item_salePrice = link_parser.find("span", class_="catalog-detail__item-price-old-main").text if link_parser.find("span", class_="catalog-detail__item-price-old-main") != None else item_basePrice
        list_items.append({
            'item_id' : int(item_id),
            'item_name' : item_name,
